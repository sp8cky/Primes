...
from sympy import gcd, factorint, primerange, isprime, divisors, totient, perfect_power, cyclotomic_poly, GF, Poly
...
def optimized_pocklington_test(n: int, seed: Optional[int] = None) -> bool: ##5.8
    ...
    # Faktorisiere n-1 als F*R mit ggt(F,R)=1
    factors = factorint(n - 1)
